...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/adminuser/.rvm/rubies/ruby-2.0.0-p481")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/adminuser/.rvm/rubies/ruby-2.0.0-p481' '--with-openssl-dir=/usr/local' '--disable-install-doc' '--enable-shared'"
